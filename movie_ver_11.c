...
void addMovieToFile(const char *filename, const char *movieName) {
    ...
    fprintf(file, "%s\n", movieName); // Write the movie name to the file
    fclose(file); // Close the file
}

// Function to display the list of movies from the file
void displayMovieList(const char *filename)
{
...
{
    FILE *file = fopen(filename, "w"); // Open the file in write mode to clear the content
